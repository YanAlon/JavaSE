...
public class Extends09PuzzleReSetJAR extends JFrame {
...
//                System.out.println(pictures[i][j]);
                JLabel segmentPicture = new JLabel(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/" + pictures[i][j] + ".png")));
    ...
    private void reset() {
        ...
        leftJB.setEnabled(true);
        rightJB.setEnabled(true);
    }
...
//                System.out.println("Reset");
    ...
    // 构造类
    public Extends09PuzzleReSetJAR() {
        initPuzzle();
    ...
    public void paintPuzzle() {
        ...
        // 标题图片
        JLabel titlePictureJL = new JLabel(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/title.png")));
...
//                System.out.println(pictures[i][j]);
        ...
        this.add(gameJP);
        // 参照图
        JLabel referenceJL = new JLabel(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/reference.png")));
        referenceJL.setBounds(574, 114, 122, 121);
        this.add(referenceJL);
        // 上按钮
        upJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/up.png")));
        upJB.setBounds(732, 265, 57, 57);
        this.add(upJB);
        // 下按钮
        downJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/down.png")));
        downJB.setBounds(732, 347, 57, 57);
        this.add(downJB);
        // 左按钮
        leftJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/left.png")));
        leftJB.setBounds(650, 347, 57, 57);
        this.add(leftJB);
        // 右按钮
        rightJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/right.png")));
        rightJB.setBounds(813, 347, 57, 57);
        this.add(rightJB);
        // 求助按钮
        helpJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/help.png")));
        helpJB.setBounds(626, 444, 108, 45);
        this.add(helpJB);
        // 重置按钮
        resetJB = new JButton(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/reset.png")));
        resetJB.setBounds(786, 444, 108, 45);
        this.add(resetJB);
        // 背景图：需要写在最后，JLabel 按照顺序堆叠？
        JLabel backgroundJL = new JLabel(new ImageIcon(Extends09PuzzleReSet.class.getResource("/images/background.png")));
...
//        System.out.println("Please select the JFrame you want to launch");
        Extends09PuzzleReSetJAR puzzleReSet = new Extends09PuzzleReSetJAR();
    }
}
