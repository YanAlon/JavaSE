...
/*
    日期选择器，可以指定日期的显示格式
 */
public class JFrame10DateChooser extends JPanel {
    ...
    public static JFrame10DateChooser getInstance() {
        return new JFrame10DateChooser();
    }

    public static JFrame10DateChooser getInstance(Date date) {
        return new JFrame10DateChooser(date);
    }

    public static JFrame10DateChooser getInstance(String format) {
        return new JFrame10DateChooser(format);
    }

    public static JFrame10DateChooser getInstance(Date date, String format) {
        return new JFrame10DateChooser(date, format);
    }

    /**
     * Creates a new instance of JFrame10DateChooser
     */
    private JFrame10DateChooser() {
        this(new Date());
    }

    private JFrame10DateChooser(Date date) {
        this(date, "yyyy年MM月dd日");
    }

    private JFrame10DateChooser(String format) {
        this(new Date(), format);
    }

    private JFrame10DateChooser(Date date, String format) {
        initDate = date;
    ...
    public static void main(String[] args) {
        ...
        //创建日期选择器对象，指定日期字符串格式
        JFrame10DateChooser dateChooser = JFrame10DateChooser.getInstance("yyyy-MM-dd");
